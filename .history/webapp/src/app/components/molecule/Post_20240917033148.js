    ...
    return (
        <View
            style={{
                ...
                width: Platform.OS === 'web' ? '50%' : 'auto', // Adjust width for web
                maxWidth: Platform.OS === 'web' ? '600px' : '100%', // Ensure it's not too wide on web
                borderWidth: Platform.OS === 'web' ? '2px' : 2, // Adjust borderWidth for web
